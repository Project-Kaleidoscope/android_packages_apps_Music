 ...
 */
class KscopeAudioPreview : Activity(), OnPreparedListener, OnErrorListener, OnCompletionListener {
    ...
    override fun onCreate(icicle: Bundle?) {
        ...
        setContentView(R.layout.kscope_audio_preview)
            ...
            override fun onQueryComplete(token: Int, cookie: Any?, cursor: Cursor?) {
                if (cursor != null && cursor.moveToFirst()) {
                    ...
                    if (mediaArtist != null) {
                        ...
                        mTextLine2.text = getString(R.string.kscope_audio_preview_artist_unknown)
                    }
                } else {
    ...
    private fun updatePlayPause() {
        ...
        if (b != null && mPlayer != null) {
            if (mPlayer!!.isPlaying) {
                b.setImageResource(R.drawable.kscope_audio_preview_pause_ic)
            } else {
                b.setImageResource(R.drawable.kscope_audio_preview_play_ic)
                mProgressRefresher.removeCallbacksAndMessages(null)
            }
        }
    }
